      ...
      <div className="container mx-auto px-4 custom-mobile-spacing">
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6 max-w-6xl mx-auto mb-12">
          {features.map((feature, index) => (
            <div key={index} className="bg-card rounded-2xl p-6 text-center border border-primary/20 hover:border-primary transition-all duration-300 shadow-soft">
            ...
            <div>
              ...
              <ul className="space-y-4">
                <li className="flex items-center gap-4 bg-white/60 p-3 rounded-xl border border-primary/5">
                  <span className="w-8 h-8 bg-linear-to-br from-primary to-accent rounded-full flex items-center justify-center text-sm text-primary-foreground font-bold shadow-md shrink-0">1</span>
                  <span className="font-medium text-foreground/90">रोज़ाना रात को use करें</span>
                </li>
                <li className="flex items-center gap-4 bg-white/60 p-3 rounded-xl border border-primary/5">
                  <span className="w-8 h-8 bg-linear-to-br from-primary to-accent rounded-full flex items-center justify-center text-sm text-primary-foreground font-bold shadow-md shrink-0">2</span>
                  <span className="font-medium text-foreground/90">Minimum 2 weeks continue करें</span>
                </li>
                <li className="flex items-center gap-4 bg-white/60 p-3 rounded-xl border border-primary/5">
                  <span className="w-8 h-8 bg-linear-to-br from-primary to-accent rounded-full flex items-center justify-center text-sm text-primary-foreground font-bold shadow-md shrink-0">3</span>
